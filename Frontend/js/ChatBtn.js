...
export const ADD = `<div class="frame-wrapper">
	<div class="rectangle-parent-user">
		...
		<div class="change-username">ADD User</div>
	</div>
</div>
...
export const PLAY = `<div class="frame-wrapper">
	<div class="rectangle-parent-user">
		<img
			class="rectangle-icon-user"
			alt=""
		...
		<div class="change-username">Start a Game</div>
	</div>
</div>
<div class="start-a-game-with-mel-moun-parent">
	<div class="select-new-username">Start a Game With mel-moun</div>
	<div class="sette-wrapper">
